package com.hankkin.multipurposelistview.refreshlayout;
...
import com.hankkin.multipurposelistview.R;
...
//        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        mTouchSlop = 200;
        footerView = LayoutInflater.from(context).inflate(R.layout.listview_foot, null,
                false);
